...
namespace yumufengkaiping\helpers;
use Exception;
...
//                $result = $object->toArray([], [], $recursive);
     ...
     * ```php
     * // working with array
     * $username = \app\common\library\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \app\common\library\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \app\common\library\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \app\common\library\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = \app\common\library\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * // working with array
     * $type = \app\common\library\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * $removed = \app\common\library\ArrayHelper::removeValue($array, 'Jackson');
     * // result:
...
//        throw new InvalidArgumentException('Argument $needles must be an array or implement Traversable');
     ...
     * ];
     *
     * $result = \app\common\library\ArrayHelper::filter($array, ['A']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * // ]
     *
     * $result = \app\common\library\ArrayHelper::filter($array, ['A', 'B.C']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * //     'B' => ['C' => 1],
     * // ]
     *
     * $result = \app\common\library\ArrayHelper::filter($array, ['B', '!B.C']);
     * // $result will be:
     * // [
     * //     'B' => ['D' => 2],
     * // ]
